...
## Current Product State - V1.0.2 Freeware Patch Release Target

XVatsim V1.0.2 is the current freeware Windows/X-Plane 12/xPilot release target.

Active V1.0.2 freeware package target:

- `releases\XVatsim_1.0.2_Freeware_Windows_XP12.zip`
- Package SHA-256:
  generated by the release gate during packaging
